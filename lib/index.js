...
var g = u.default.svg(r),
  ...
  y = (function (n) {
    function o (n) {
      ...
      return (
        console.log(n), (e.state = { isHover: !1, label: n.labels.copy }), e
      )
    }
    return (
      (function (n, e) {
            ...
            return t(
              ...
              t(
                c.CopyToClipboard,
                {
                  ...
                  onCopy: function () {
                    return n.setState({ label: r.copied })
                  }
                },
                void 0,
                t(
                  x,
                  {
                    ...
                    'aria-label': e.label,
                    onMouseLeave: function () {
                      return n.setState({ label: r.copy })
                    }
                  },
                  void 0,
                  t(m, {})
              ...
              s.default.createElement(i, this.props)
            )
          }
        }
      ]),
...
y.defaultProps = { labels: { copy: 'Copy to clipboard', copied: 'Copied!' } }
